...
// The End CotialBUTTONS***********************************


// function twit(){
// $('.tweet').attr("href", "https://twitter.com/intent/tweet?text=" + "Пройди сам и проверь себя! А мой результат - "+ results[win]);
// }
...
// function checking(val){
//   if(val == '2'){
//     $('label').('input[name='+block+']:checked').addClass('right');
//   }
// }
...
// alert($('input[name="block1"]:checked', '#press1').val()); 
